...
export class QuestionService implements IDatabaseClient<IQuestion> {
  private dataDummy: { testId: string; questions: IQuestion[] }[] = [
    {
      testId: '1',
      questions: [
        {
        ...
        },
        {
          ...
          option: [
            {
              id: 'a',
              text: 'Dia belajar di perpustakaan sejak pagi.',
              points: 0,
            },
            {
              id: 'b',
            ...
            {
              id: 'c',
              text: 'Pertemuan akan di mulai pukul 10.00.',
              points: 5,
            },
            {
              id: 'd',
              text: 'Mereka berdiskusi tentang proyek baru.',
              points: 0,
            },
            {
              id: 'e',
        ...
        },
        {
          ...
          option: [
            ...
            {
              id: 'b',
              text: 'Hanya mengutamakan kepentingan pribadi.',
              points: 0,
            },
        ...
        },
        {
          ...
          option: [
            ...
            {
              id: 'd',
              text: 'Menolak kerja sama dengan negara lain.',
              points: 0,
            },
            {
              id: 'e',
        ...
        },
        {
          ...
          option: [
            {
              id: 'a',
              text: 'Mengikuti upacara bendera secara rutin.',
              points: 5,
            },
            {
              id: 'b',
  ...
  getSingle(
    where: IWhereClause,
    columns?: (keyof IQuestion)[] | undefined,
  ...
  getList = async (
    ...
    const { testId } = where;
    const q = this.dataDummy.find((el) => el.testId === testId);
    if (q) {
      return q.questions.map((el) => {
        if (columns) {
          return columns.reduce((acc, el2) => {
            return {
              ...acc,
              [el2]: el[el2 as keyof IQuestion],
            };
          }, {} as IQuestion);
        }
        return el;
